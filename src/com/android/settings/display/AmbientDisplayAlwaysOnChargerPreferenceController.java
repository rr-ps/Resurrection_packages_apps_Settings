...
public class AmbientDisplayAlwaysOnChargerPreferenceController extends
    ...
    public static final String KEY_ALWAYS_ON = "ambient_display_always_on_charger";
    ...
    public AmbientDisplayAlwaysOnChargerPreferenceController(Context context,
    ...
    public void updateState(Preference preference) {
        ((SwitchPreference) preference).setChecked(isAlwaysOnChargerEnabled(mConfig));
    }

    public static boolean isAlwaysOnChargerEnabled(AmbientDisplayConfiguration config) {
        return config.alwaysOnChargerEnabled(MY_USER);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Settings.Secure.putInt(
                mContext.getContentResolver(), Settings.Secure.DOZE_ALWAYS_ON_CHARGER, enabled);
        if (mCallback != null) {
    ...
    public ResultPayload getResultPayload() {
        ...
        return new InlineSwitchPayload(Settings.Secure.DOZE_ALWAYS_ON_CHARGER,
